...
import {Cloud, GridCloud, GridCube, GridRing, GridRoundedBox, GridSphere, Star} from './GridSphere';
...
import LightingNode from "three/addons/nodes/lighting/LightingNode";
...
export const ShapeGrid = () => {
    ...
    const handleClick = (sphereRef, note) => {
        ...
        const endColor = new THREE.Color(currentColor);
